    ...
    <div class="container">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                // Kiểm tra xem $customers có dữ liệu không trước khi lặp
                if (!empty($customers)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger">
                                        <a href="index.php?deleteId=<?php echo $customer['id'] ?>" onclick="confirm('Are you sure want to delete this record')">
                    ...
                    // Xuất thông báo nếu không có dữ liệu
